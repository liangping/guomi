...
fn rl(x: u32, i :u8) -> u32 { return (x << (i % 32)) | (x >> (32 - (i % 32))) }

fn l0(b: u32) -> u32 { return b ^ rl(b, 13) ^ rl(b, 23) }

fn feistel0(x0:u32, x1:u32, x2:u32, x3:u32, rk :u32) -> u32 { return x0 ^ l0(p(x1^x2^x3^rk)) }

fn uint8(x: u32) -> u8{ return x as u8}
fn uint32(x: u8) ->u32 { return x as u32}
